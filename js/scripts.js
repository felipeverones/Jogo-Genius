...
_gui.switch.addEventListener("click", () => {
	...
	_gui.counter.innerHTML = "--" /* display sempre liga com -- */
	...
	_gui.led.classList.remove("gui__led--active") /* desliga o led quando desligar o jogo*/
});
/* ============================================================== */
...
_gui.strict.addEventListener("click", () => {
	...
	if (!_data.gameOn) { /* se o pai ta off */
		return	
	}
...
/* ==========Muda o tipo do cursor quando for clicável=========== */
